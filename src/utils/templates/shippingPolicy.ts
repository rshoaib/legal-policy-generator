...
export const generateShippingPolicy = (data: PolicyData): string => {
    ...
    let s = 2; // section counter (starts after "1. Order Processing" and "2. Shipping Methods")

    const freeShippingSection = freeThreshold ? `
${++s}. Free Shipping
...
` : '';
    ...
    const internationalSection = intl ? `
...
` : '';
    ...
    const restrictionsSection = restrictions ? `
...
${freeShippingSection}${internationalSection}
${++s}. Shipment Tracking
...
${++s}. Lost, Damaged, or Stolen Packages
