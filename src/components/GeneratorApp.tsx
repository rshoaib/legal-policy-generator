...
export function GeneratorApp() {
  ...
  /* Legacy /?type=X and /?q= redirects are now handled server-side in next.config.ts */
  useEffect(() => {
  ...
  /* Note: canonical, openGraph, twitter, and JSON-LD are now emitted server-side
     from app/page.tsx and app/layout.tsx. */
