...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `      <img src="/images/blog/aup-policy-hero.png" alt="A clean, modern illustration for a blog article about Acceptable Use Policies (AUP) and cybersecurity. Shield and lock icons for privacy." style="width:100%; border-radius:12px; margin-bottom:2rem;" />
