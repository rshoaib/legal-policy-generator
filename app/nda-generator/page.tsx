...
const URL = 'https://legalpolicygen.com/nda-generator'
const TITLE = 'Free NDA Generator — Non-Disclosure Agreement (2026)'
const DESC =
  'Create a customized Non-Disclosure Agreement (NDA) to protect your confidential information and trade secrets.'
...
const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'NDA Generator', item: URL },
    ],
  }
