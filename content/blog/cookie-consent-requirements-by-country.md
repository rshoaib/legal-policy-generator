...
---
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 360" role="img" aria-label="Cookie compliance banner" style="width:100%;height:auto;border-radius:12px;margin-bottom:24px;display:block;"><defs><linearGradient id="g_f_8624" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#ecfeff"/><stop offset="100%" stop-color="#a5f3fc"/></linearGradient></defs><rect width="1200" height="360" fill="url(#g_f_8624)"/><circle cx="732" cy="291" r="7" fill="#4338ca" fill-opacity="0.34"/><circle cx="976" cy="255" r="3" fill="#4338ca" fill-opacity="0.38"/><circle cx="324" cy="91" r="3" fill="#4338ca" fill-opacity="0.26"/><circle cx="1016" cy="303" r="4" fill="#4338ca" fill-opacity="0.26"/><circle cx="716" cy="123" r="5" fill="#4338ca" fill-opacity="0.28"/><circle cx="960" cy="279" r="6" fill="#4338ca" fill-opacity="0.44"/><circle cx="532" cy="51" r="6" fill="#4338ca" fill-opacity="0.34"/><circle cx="40" cy="223" r="6" fill="#4338ca" fill-opacity="0.20"/><circle cx="348" cy="115" r="6" fill="#4338ca" fill-opacity="0.30"/><circle cx="112" cy="103" r="5" fill="#4338ca" fill-opacity="0.30"/><circle cx="164" cy="347" r="3" fill="#4338ca" fill-opacity="0.30"/><circle cx="680" cy="359" r="5" fill="#4338ca" fill-opacity="0.28"/><circle cx="236" cy="251" r="7" fill="#4338ca" fill-opacity="0.20"/><circle cx="288" cy="47" r="6" fill="#4338ca" fill-opacity="0.26"/><circle cx="116" cy="211" r="7" fill="#4338ca" fill-opacity="0.44"/><circle cx="24" cy="287" r="3" fill="#4338ca" fill-opacity="0.32"/><circle cx="220" cy="27" r="4" fill="#4338ca" fill-opacity="0.16"/><circle cx="480" cy="335" r="7" fill="#4338ca" fill-opacity="0.28"/><path d="M0 221 Q 30 253 60 221 Q 90 189 120 221 Q 150 253 180 221 Q 210 189 240 221 Q 270 253 300 221 Q 330 189 360 221 Q 390 253 420 221 Q 450 189 480 221 Q 510 253 540 221 Q 570 189 600 221 Q 630 253 660 221 Q 690 189 720 221 Q 750 253 780 221 Q 810 189 840 221 Q 870 253 900 221 Q 930 189 960 221 Q 990 253 1020 221 Q 1050 189 1080 221 Q 1110 253 1140 221 Q 1170 189 1200 221 Q 1230 253 1260 221 " fill="none" stroke="#4338ca" stroke-opacity="0.18" stroke-width="3"/><g transform="translate(433,170)" stroke="#4338ca" stroke-width="4"><circle r="95" fill="#ffffff" fill-opacity="0.6"/><circle cx="-30.0" cy="-20.0" r="8" fill="#4338ca"/><circle cx="20.0" cy="-40.0" r="6" fill="#4338ca"/><circle cx="40.0" cy="10.0" r="9" fill="#4338ca"/><circle cx="-10.0" cy="35.0" r="7" fill="#4338ca"/><circle cx="-45.0" cy="30.0" r="5" fill="#4338ca"/><circle cx="30.0" cy="45.0" r="6" fill="#4338ca"/></g><g transform="translate(933,185)" stroke="#4338ca" stroke-width="5" fill="#ffffff" fill-opacity="0.6" stroke-linejoin="round"><path d="M-65.0 13.0 Q-91.0 13.0 -91.0 -13.0 Q-91.0 -39.0 -58.5 -35.75 Q-52.0 -61.75 -13.0 -55.25 Q26.0 -65.0 35.75 -32.5 Q71.5 -35.75 71.5 0.0 Q71.5 26.0 39.0 26.0 H-65.0 Q-91.0 26.0 -65.0 13.0 Z"/></g></svg>
