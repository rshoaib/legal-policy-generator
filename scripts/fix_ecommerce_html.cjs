...
<img src="/ecommerce-legal-hero.png" alt="Ecommerce Legal Requirements" />
...
<h2>1. A Compliant Privacy Policy</h2>
...
<h2>2. Solid Terms and Conditions</h2>
...
<h2>3. A Crystal Clear Return and Refund Policy</h2>
...
<h2>4. Shipping and Delivery Terms</h2>
...
<h2>6. Payment Security and PCI Compliance</h2>
...
<h2>Protect Your Store Today</h2>

<p>Ignoring the legal requirements for ecommerce websites is like driving without insurance. It's fine—right up until it's a disaster. Getting compliant doesn't have to cost thousands of dollars in attorney fees. We built <a href="/">LegalPolicyGen</a> to help founders like you protect your business instantly using our free suite of legal generation tools.</p>
`;

async function main() {
  const db = new SupabaseREST();
  console.log('Restoring image and rich HTML styling...');
